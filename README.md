...
- 정상 거래당 위험은 현재 자산의 `2%`, BTC 최대 노출은 `70%`입니다. 고점 대비 `15%` 낙폭 사건은 강제 청산과 `72시간` 대기를 한 번 시작합니다. 정확히 72시간부터 다른 정지가 없고 시스템이 정상이면 낙폭이 남아도 축소 재개합니다. 낙폭 10%/5%/0% 초과 구간의 회복 위험·상한은 각각 0.25%·15% / 0.5%·30% / 1%·50%이며, 이전 최고자산 회복 시 정상으로 돌아갑니다. 독립 정지·축소 조건은 계속 더 엄격하게 적용합니다.
